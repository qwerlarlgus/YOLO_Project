...
def detect(save_img=False):
    source, weights, view_img, save_txt, imgsz = 'data/images', 'yolov5s.pt', 'store_true', 'store_true', 640
    ...
    for path, img, im0s, vid_cap in dataset:
        ...
        # Apply NMS
        pred = non_max_suppression(pred, 0.25, 0.45, None, agnostic='store_true') # classes=opt.classes -> None
